...
function WorkTab({
  ...
  return (
    <>
      <Link
        href={link}
        className="w-full flex flex-col lg:flex-row space-y-3 lg:space-y-0 justify-between items-start lg:items-center py-6"
      >
        <div className="flex justify-center items-center space-x-2">
          <Image
            ...
            alt="Work"
            priority
            className="self-start rounded-full w-12 h-12"
          />
        ...
        <div className="text-gray-700 self-end lg:self-center font-normal text-base xl:text-lg">
          {startDate} - {endDate}
        </div>
      </Link>
    </>
    ...
    <>
      <section id="work">
        <Container className="flex flex-col justify-center items-start space-y-4 border-b border-b-borderColor xl:py-20 lg:py-16 py-12 px-4 xl:px-8">
          ...
          <WorkTab
            link="https://triontechsolution.com"
            imgSrc={TrionTech}
            company="Trion Tech Solutions"
            position="Junior Frontend Developer"
            startDate="Feb 2024"
            endDate="Aug 2024"
          />
          <WorkTab
            link="http://neutroline.com"
            imgSrc={Neutroline}
            company="Neutroline Pvt. Ltd."
            position="Fullstack PHP Intern"
            startDate="Mar 2023"
            endDate="Sep 2023"
          />
        </Container>
